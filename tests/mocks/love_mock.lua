...
love_mock.audio = {
  newSource = function(path, type)
    return {
      ...
      setLooping = function(self, l)
        self.looping = l
      end,
      setPosition = function(self, x, y, z)
        self.position = { x, y, z }
      end,
      setRelative = function(self, r)
        self.relative = r
      end,
...
love_mock.window = {
  ...
  getMode = function()
    return 1280, 720, { fullscreen = false }
  end,
